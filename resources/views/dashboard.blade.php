    ...
    <div class="flex-1 overflow-y-auto relative px-6 py-6 transition-colors duration-300">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-6" id="metric-cards" data-stats="today">
            @foreach ([
                ...
                ['label' => 'Open Tables', 'value' => '8 / 16', 'change' => '50% occ.', 'up' => true, 'icon' => 'utensils', 'color' => 'from-amber-500 to-orange-500', 'glow' => 'bg-amber-500', 'sub' => '4 tables occupied', 'cls' => 'fg-kpi-3'],
                ['label' => 'Low Stock Alerts', 'value' => count($stockAlerts), 'change' => 'Needs reorder', 'up' => false, 'icon' => 'alert-triangle', 'color' => 'from-red-500 to-rose-500', 'glow' => 'bg-red-500', 'sub' => '1 critical', 'cls' => 'fg-kpi-4'],
            ] as $stat)
