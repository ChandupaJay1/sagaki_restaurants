...
function TableCard({ table, onClick }) {
    ...
    return (
        ...
        >
            ...
            {/* Table info */}
            <div>
                <p className="text-white font-bold text-lg leading-none">{table.name}</p>
            ...
            {table.status === 'occupied' && (
                <div className="pt-2 border-t border-white/10 mt-1">
                    <p className="text-white text-sm font-medium">{table.customer}</p>
            ...
            {table.status === 'reserved' && (
                <div className="pt-2 border-t border-white/10 mt-1">
                    <p className="text-amber-400 text-sm font-medium">{table.customer}</p>
                    <p className="text-slate-400 text-xs mt-0.5">
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            ">
                {/* Header */}
                <div className="
                    px-6 py-4 border-b border-slate-700/60
                ...
                ">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-400 text-xs">{table.seats} seats</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                {/* Tabs */}
                <div className="
                    flex border-b border-slate-700/60 px-6
                ">
                    {[
                ...
                <div className="px-6 py-5 min-h-64">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="bg-slate-700/40 rounded-xl p-3">
                                    ...
                                    <p className="text-white font-semibold">{table.seats}</p>
                                </div>
                                {table.status === 'occupied' && (
                                    <>
                                        <div className="bg-slate-700/40 rounded-xl p-3">
                                            <p className="text-slate-400 text-xs mb-1">Customer</p>
                                            <p className="text-white font-semibold">{table.customer}</p>
                                        </div>
                                        <div className="bg-slate-700/40 rounded-xl p-3">
                                            <p className="text-slate-400 text-xs mb-1">Bill Total</p>
                                            <p className="text-indigo-400 font-bold">LKR {table.bill.toLocaleString()}</p>
                                        </div>
                                        <div className="bg-slate-700/40 rounded-xl p-3">
                                            <p className="text-slate-400 text-xs mb-1">Started At</p>
                                            <p className="text-white font-semibold">{table.startedAt}</p>
                                        </div>
                                        <div className="bg-slate-700/40 rounded-xl p-3">
                                            <p className="text-slate-400 text-xs mb-1">Table Type</p>
                                            <p className="text-white font-semibold">{table.type.replace('-', ' ')}</p>
                                        </div>
                                    </>
                                )}
                                {table.status === 'reserved' && (
                                    <>
                                        <div className="bg-slate-700/40 rounded-xl p-3">
                                            <p className="text-slate-400 text-xs mb-1">Guest Name</p>
                                            <p className="text-white font-semibold">{table.customer}</p>
                                        </div>
                                        <div className="bg-slate-700/40 rounded-xl p-3">
                                            <p className="text-slate-400 text-xs mb-1">Reservation</p>
                                            <p className="text-white font-semibold">{table.startedAt}</p>
                                        </div>
                                    </>
                                )}
                            ...
                            <div className="flex gap-2 pt-2">
                                ...
                                {table.status === 'occupied' && (
                                    <>
                                        <button
                                            ...
                                            className="
                                                flex-1 py-2.5 bg-emerald-600/20 border border-emerald-500/40
                                                text-emerald-400 text-sm font-semibold rounded-xl
                                                transition-colors flex items-center justify-center gap-2
                                            "
                                        >
                                            <CreditCard size={14} />
                                        ...
                                        <button
                                            ...
                                            className="
                                                flex-1 py-2.5 bg-red-500/20 border border-red-500/40
                                                text-red-400 text-sm font-semibold rounded-xl
                                                transition-colors flex items-center justify-center gap-2
                                            "
                                        >
                                            <CheckCircle2 size={14} />
                                ...
                                {table.status === 'reserved' && (
                                    <button
                                        ...
                                        className="
                                            flex-1 py-2.5 bg-amber-500/20 border border-amber-500/40
                                            text-amber-400 text-sm font-semibold rounded-xl
                                            transition-colors flex items-center justify-center gap-2
                                        "
                                    >
                                        <Users size={14} />
                    ...
                    {activeTab === 'transfer' && (
                        <div className="space-y-4">
                            <p className="text-slate-400 text-sm">
                                Transfer <span className="text-white font-semibold">{table.name}</span> to another table:
                            </p>
                                ...
                                {availableTables.map((t) => (
                                    <button
                                        ...
                                        className="
                                            ...
                                            border border-slate-600/40 hover:border-indigo-500/40
                                            rounded-xl transition-colors text-left
                                        "
                                    >
                                        <Table2 size={16} className="text-indigo-400 flex-shrink-0" />
                                        <div className="flex-1">
                                            <p className="text-white text-sm font-medium">{t.name}</p>
                                            <p className="text-slate-400 text-xs">{t.seats} seats · {t.type.replace('-', ' ')}</p>
                                        </div>
                    ...
                    {activeTab === 'merge' && (
                        <div className="space-y-4">
                            <p className="text-slate-400 text-sm">
                                Merge <span className="text-white font-semibold">{table.name}</span> with another table:
                            </p>
                            <div className="space-y-2">
                                    ...
                                    .map((t) => (
                                        <button
                                            ...
                                            className="
                                                w-full flex items-center gap-3 p-3
                                                bg-slate-700/40 hover:bg-slate-700
                                                border border-slate-600/40 hover:border-violet-500/40
                                                rounded-xl transition-colors text-left
                                            "
                                        >
                                            <div className="
                                                w-8 h-8 bg-red-500/20 rounded-lg
                                                flex items-center justify-center flex-shrink-0
                                            ">
                                                <span className="text-red-400 text-xs font-bold">{t.name}</span>
                                            </div>
                                            <div className="flex-1">
                                                <p className="text-white text-sm font-medium">{t.name} — {t.customer}</p>
                                                <p className="text-slate-400 text-xs">{t.seats} seats</p>
                                            </div>
                ...
                {/* Footer */}
                <div className="
                    px-6 py-4 border-t border-slate-700/60
            ...
            <div className="flex flex-col h-full">
                ...
                ">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-400 text-xs mt-0.5">Floor plan & reservations</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        {[
                            { label: 'Available', count: stats.available, color: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/30' },
                            { label: 'Occupied', count: stats.occupied, color: 'text-red-400', bg: 'bg-red-500/10', border: 'border-red-500/30' },
                            { label: 'Reserved', count: stats.reserved, color: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/30' },
                        ].map((stat) => (
                            <div
                                key={stat.label}
                ...
                <div className="flex-1 overflow-y-auto px-6 py-6">
                    ...
                    <div className="bg-slate-800/50 border border-slate-700/40 rounded-2xl p-6">
                        {/* Kitchen label */}
                        <div className="
                            mb-4 px-4 py-2 bg-slate-700/30 border border-slate-600/40
                            ...
                            {TABLE_LAYOUT.map((row, rowIdx) => (
                                <div key={rowIdx} className="flex gap-3 justify-center">
                                    {row.map((tableId) => {
                                        ...
                                        return (
                                            <div key={tableId} className="w-36">
                        ...
                        {/* Entrance */}
                        <div className="
                            mt-4 px-4 py-2 bg-slate-700/20 border border-dashed border-slate-600/30
                            rounded-xl text-center
                        ">
                            <span className="text-slate-500 text-xs font-medium uppercase tracking-wider">
                                Entrance
                    ...
                    <div className="mt-6 flex flex-wrap gap-4 justify-center">
                        {[
                            { label: '2-Top', color: 'bg-slate-600' },
                            { label: '4-Top', color: 'bg-slate-500' },
                            { label: '6-Top', color: 'bg-slate-400' },
                            { label: '8-Top', color: 'bg-slate-300' },
                            ...
                            <div key={type.label} className="flex items-center gap-2">
                                ...
                                <span className="text-slate-400 text-xs">{type.label}</span>
                            </div>
                        ))}
                    </div>
                </div>
